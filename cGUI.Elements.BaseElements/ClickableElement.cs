...
public class ClickableElement : HoverableElement, IEventHandler<MouseKeyDownEvent>, IEventHandler<MouseKeyUpEvent>, IEventHandler<PostLayoutEvent>
{
    ...
    public ClickableElement(string id, ElementOption options, GUIColor[] hoveredColor, GUIColor[] pressedColor, ElementTweenOptions tweenOptions = default) : base(id, options, hoveredColor, tweenOptions)
    {
        ...
        m_PressTween = new StateTween<float>(tweenOptions.PressInDuration, tweenOptions.PressOutDuration, (a, b, t) => GUIMath.LerpUnclamped(a, b, t), tweenOptions.PressEasing);
    }
    ...
    protected override GUIColor[] ComputeColors()
    {
        ...
        var hovered = LerpColorArrays(m_Color, m_HoveredColor, hoverT);
        return LerpColorArrays(hovered, m_PressedColor, pressT);
    }
